    ...
    return (
        <div>
            <div className='md:container md:mx-auto hidden lg:flex lg:justify-between text-white text-sm main p-4 top box-border'>
                <div className='flex'>
                    <div>
                        ...
                        <span className='hover:cursor-pointer'>Ring road patang chowk</span>
                    </div>
                    <div>
                        <span className="fas fa-envelope secondary pr-3 pl-4"></span>
                        <span className='hover:cursor-pointer'>mnidal414@gmail.com</span>
                    </div>
                </div>
                <div className='pr-4'>
            ...
            <div
                ...
                className='md:container md:mx-auto flex justify-between m-6'
            >
